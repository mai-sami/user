...
<option value="3">الدمام</option>
           ...
           <br />
           <Form.Label   id="pre__selects">  الرياض، الغدير، طريق الملك عبد العزيز</Form.Label>
           <br />

           <Form.Label   id="pre__selects">  الدمام</Form.Label>
        ...
        <div className="div__buttons">
          ...
          <Button type="submit" id="sure__text__addres" onClick={CloseAddrees} >
            تاكيد</Button>
